...
public class EloEngine {
    ...
    // NEW: The number of times the engine will replay the tournament
    private static final int ITERATION_PASSES = 3;
    ...
    public static void calculateTrueRank(List<SeasonRanking> teams, JsonNode matchArray) {
        ...
        // We only reset everyone to 1500 ONCE at the very beginning
        ...
        if (matchArray != null && matchArray.isArray()) {
            ...
            // --- NEW: THE TIME MACHINE LOOP ---
            for (int pass = 0; pass < ITERATION_PASSES; pass++) {

                // Reset match counts for K-Factor decay at the start of every pass
